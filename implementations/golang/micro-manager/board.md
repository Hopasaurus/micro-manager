...
- [ ] [T-0241] Decide and implement --init's version-2 story (spec-tools.md §5.1.1 already describes v2 output) | stage:ready | prio:high | tags:columns,migration,golang,design | detail:details/T-0241.md | created:2026-08-21
